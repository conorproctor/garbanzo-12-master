                ...
                if (isset($_SESSION['username'])) {
                  ...
                  $users = $mysqli->query("SELECT * FROM users WHERE username='$username'");
                   ...
                   <center><div class="w3-container" style="margin-top:60px">
                      ...
                      <br><br> <a href="profile.php?user=<?php echo $user_data['username'] ?>" class="btn btn-primary btn-lg enabled" role="button" aria-disabled="true">Click here to go to your profile</a>
                  </div></center>
                <?php }
               }
               ?>
