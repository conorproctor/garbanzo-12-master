                     ...
                     <body>
                       ...
                       <nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
                           ...
                           <div class="w3-bar-block">
                               ...
                               <a href="landlord-matches.php?user=<?php echo $user_data['user_id'] ?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-gray"><span class="fa fa-handshake-o"></span>  Your matches</a>
